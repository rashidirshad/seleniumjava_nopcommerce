package com.nopcommerce_app.utilities;
	...
	try {
		...
		/*
		 // Create the email message
		  ...
		  email.setAuthenticator(new DefaultAuthenticator("sardarashid000@gmail.com", "Sardarashid!@##@!1"));
		  email.setSSLOnConnect(true);
		  email.setFrom("sardarashid000@gmail.com");   //Sender
		  email.setSubject("Test Results");
		  email.setMsg("Please find Attached Report....");
		  email.addTo("sardarashid000@gmail.com");   //Receiver
